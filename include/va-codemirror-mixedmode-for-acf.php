...
if ( class_exists( 'acf_field' ) AND ! class_exists( 'acf_field_cm_mixedmode' ) ) :
class acf_field_cm_mixedmode extends acf_field {
	private $version     = '';
	private $vacmacf_url = '';
	...
	*/
	...
	function admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'admin-va-codemirror-acf-addon-csshint', $this->vacmacf_url . '/assets/js/lib/codemirror/addon/hint/css-hint.min.js', array('admin-va-codemirror-acf-addon-hint'), $this->version, false );
		...
		wp_enqueue_script( 'admin-va-codemirror-acf-mode-css', $this->vacmacf_url . '/assets/js/lib/codemirror/mode/css.min.js', array('admin-va-codemirror-acf-addon-jshint'), $this->version, false );
		...
		wp_enqueue_script( 'admin-va-codemirror-acf-mode-vbscript', $this->vacmacf_url . '/assets/js/lib/codemirror/mode/vbscript.min.js', array('admin-va-codemirror-acf-addon-jshint'), $this->version, false );
		wp_enqueue_script( 'admin-va-codemirror-acf-mode-htmlmixed', $this->vacmacf_url . '/assets/js/lib/codemirror/mode/htmlmixed.min.js', array('admin-va-codemirror-acf-addon-jshint'), $this->version, false );
	}
