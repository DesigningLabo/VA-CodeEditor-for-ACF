...
if ( class_exists( 'acf_field' ) AND ! class_exists( 'acf_field_cm_cssmode' ) ) :
class acf_field_cm_cssmode extends acf_field {
	private $version     = '';
	private $vacmacf_url = '';
