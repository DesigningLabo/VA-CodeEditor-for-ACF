...
if ( class_exists( 'acf_field' ) AND ! class_exists( 'acf_field_vace_cssmode' ) ) :
class acf_field_vace_cssmode extends acf_field {
	private $version     = '';
	private $vaceacf_url = '';
